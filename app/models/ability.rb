class Ability
  ...
  def initialize(user)
    ...
    # Cancancan assumes that you have a method called 'current_user' which is available in the application controller. You dont have to explicitly create an Ability Object, this will be done automatically.
